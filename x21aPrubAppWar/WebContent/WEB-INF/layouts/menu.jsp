                        ...
                        <div class="dropdown-menu menu-right">
                            ...
                            <div class="dropdown-submenu">
                                ...
                                <div class="dropdown-menu" aria-labelledby="tableDropdown">
                                    ...
                                    <spring:url value="/tableComarcaExtendida/filterSimple" var="tablecomarmaExtendida" htmlEscape="true"/>
                                    <a class="dropdown-item" href="${tablecomarmaExtendida}">
                                        <spring:message code="Tabla Comarca Extendida" />
                                    </a>
