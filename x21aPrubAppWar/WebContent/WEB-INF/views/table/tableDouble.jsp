			...
			<fieldset class="form-group">
				...
				<div class="col-sm-10">
					...
					<div class="radio-material pluginsControl">
						...
						<form:radiobutton path="editType" id="editFormTargetBlank" value="13" data-add-new-window-url="${addFromNewWindow}" data-edit-new-window-url="/x21aPrubAppWar/table/editFromNewWindow/" />
			...
			<fieldset class="form-group">
				...
				<div class="col-sm-10">
					...
					<div class="radio-material pluginsControl">
						...
						<form:radiobutton path="editType" id="editFormTargetBlank2" value="13" data-add-new-window-url="${addFromNewWindow2}" data-edit-new-window-url="/x21aPrubAppWar/table/editFromNewWindowDouble/" />
