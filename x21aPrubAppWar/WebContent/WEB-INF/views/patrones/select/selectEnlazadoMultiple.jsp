...
<!-- Feedback -->
<div id="x21aPrubAppWar_feedback"></div><br/>
	...
	<div class="form-row">
		<fieldset class="col-sm mr-sm-5">
			...
			<form:form id="departamentoProvinciaMixto1_form" modelAttribute="departamentoProvinciaDTO" action="${remoto}" method="GET">
				...
				<div class="form-groupMaterial">
					<form:select id="mixto_provincia" path="codeProvincia" items="${comboProvincia}" itemLabel="descEs" itemValue="code" />
		...
		<fieldset class="col-sm">
			...
			<form:form id="departamentoProvinciaMixto1_form" modelAttribute="departamentoProvinciaDTO" action="${remoto}" method="GET">
				<div class="form-groupMaterial">
					<form:select id="mixto2_departamento" path="codeDepartamento" items="${comboDepartamento}" itemLabel="descEs" itemValue="code" />
