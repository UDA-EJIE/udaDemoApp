...
<section class="row">
	<div class="col-12">
		...
		<p>Estos mensajes predefinidos pueden ser de diferente tipología:
			error, confirmación, aviso o alerta.</p>
		<div class="example">
			<div class="row">
				<div class="col-md-3">
		...
		<p>Por defecto también se modifica el estilo del alert nativo de
			JavaScript.</p>
