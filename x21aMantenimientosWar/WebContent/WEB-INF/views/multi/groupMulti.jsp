<%--  
 ...
 --%>
	...
	<div id="groupMulti">
		...
		<div id="RUP_GRID_group_multi">
			<!-- Tabla -->
			<table id="GRID_group_multi" cellpadding="0" cellspacing="0"></table>
			<!-- Barra de paginación -->
			<div id="group_multi_pager" style="text-align:center;"></div>
		</div>
	</div>