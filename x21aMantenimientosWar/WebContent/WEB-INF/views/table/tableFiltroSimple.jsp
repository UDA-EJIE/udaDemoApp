			...
			<fieldset id="table_filter_fieldset" class="rup-table-filter-fieldset">
				<div class="formulario_columna_cnt">
					<div class="formulario_linea_izda_float">
						...
						<form:input path="id" class="formulario_linea_input" id="id_filter_table" />
					</div>
					<div class="formulario_linea_izda_float">
						<label for="nombre_filter_table" class="formulario_linea_label"><spring:message code="nombre" />:</label>
						<form:input path="nombre" class="formulario_linea_input" id="nombre_filter_table" />
					</div>
					<div class="formulario_linea_izda_float">
						<label for="apellido1_filter_table" class="formulario_linea_label"><spring:message code="apellido1" />:</label>
						<form:input path="apellido1" class="formulario_linea_input" id="apellido1_filter_table" />
					</div>
					<div class="formulario_linea_izda_float">
					...
					<div class="formulario_linea_izda_float">
						...
						<div style="float: left;"><form:select id="ejie_filter_table" path="ejie" class="rup-combo" /></div>
					</div>
					<div class="formulario_linea_izda_float">
						<label for="fechaAlta_filter_table" class="formulario_linea_label"><spring:message code="fechaAlta" />:</label>
						<form:input path="fechaAlta" class="formulario_linea_input" id="fechaAlta_filter_table" />
					</div>
					<div class="formulario_linea_izda_float">
						<label for="fechaBaja_filter_table" class="formulario_linea_label"><spring:message code="fechaBaja" />:</label>
						<form:input path="fechaBaja" class="formulario_linea_input" id="fechaBaja_filter_table" />
					</div>
					<div class="formulario_linea_izda_float"  style="clear:left">
						...
						<form:input path="rol" class="formulario_linea_input" id="rol_filter_table" />
					</div>
				</div>
				<div id="table_filter_buttonSet" class="right_buttons">
<%-- 					<button id="table_filter_filterButton" type="button" class="ui-button ui-widget ui-state-default ui-corner-all" ><spring:message code="filter" /></button>					<a id="table_filter_cleanLink" href="javascript:void(0)" class="rup-enlaceCancelar"><spring:message code="clear" /></a> --%>
		...
		<form:form modelAttribute="usuario" id="table_detail_form">
			...
			<div class="floating_left_pad_right">
				<div class="floating_left_pad_right one-column">
					...
					<form:input path="id" class="formulario_linea_input" id="id_detailForm_table" />
				</div>
				<div class="floating_left_pad_right one-column">
					<label for="nombre_detail_table"><spring:message code="nombre" />:</label>
					<form:input path="nombre" class="formulario_linea_input" id="nombre_detail_table" />
				</div>
				<div class="floating_left_pad_right one-column">
					<label for="apellido1_detail_table"><spring:message code="apellido1" />:</label>
					<form:input path="apellido1" class="formulario_linea_input" id="apellido1_detail_table" />
				</div>
				<div class="floating_left_pad_right one-column">
					<label for="apellido2_detail_table"><spring:message code="apellido2" />:</label>
					<form:input path="apellido2" class="formulario_linea_input" id="apellido2_detail_table" />
				</div>
				<div class="floating_left_pad_right one-column">
					<label for="ejie_detail_table"><spring:message code="ejie" />:</label>
					<form:checkbox id="ejie_detail_table" path="ejie"  value="1"/>
				</div>
				<div class="floating_left_pad_right one-column">
					<label for="fechaAlta_detail_table"><spring:message code="fechaAlta" />:</label>
					<form:input path="fechaAlta" class="formulario_linea_input" id="fechaAlta_detail_table" />
				</div>
				<div class="floating_left_pad_right one-column" style="clear: left;">
					...
					<form:input path="fechaBaja" class="formulario_linea_input" id="fechaBaja_detail_table" />
				</div>
				<div class="floating_left_pad_right one-column">
					<label for="rol_detail_table"><spring:message code="rol" />:</label>
					<form:select id="rol_detail_table" path="rol" class="formulario_linea_input" />
				</div>
			</div>
		</form:form>
	</div>
