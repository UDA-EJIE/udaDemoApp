			...
			<fieldset id="table_filter_fieldset" class="rup-table-filter-fieldset">
				<div class="formulario_columna_cnt">
					...
					<div class="formulario_linea_izda_float">
						...
						<form:select id="rol_filter_table" path="rol" class="formulario_linea_input" />
					</div>
				</div>
...
<!-- 				</div> -->
				<input type="hidden" name="id" class="formulario_linea_input" id="id_detailForm_table" />
				<div class="floating_left_pad_right one-column">
				...
				<div class="floating_left_pad_right one-column">
					...
					<form:checkbox id="ejie_detail_table" path="ejie" />
				</div>
				<div class="floating_left_pad_right one-column">
				...
				<div class="floating_left_pad_right one-column">
					<label for="idPadre_detailForm_table"><spring:message code="idPadre" />:</label>
					<form:input path="idPadre" class="formulario_linea_input" id="idPadre_detailForm_table" />
				</div>
			</div>
		</form:form>
	</div>
	<div class="rup-table-buttonpane ui-widget-content ui-helper-clearfix">
		<div class="ui-dialog-buttonset">
			...
			<a href="javascript:void(0)" role="button" id="table_detail_link_cancel"
				class="rup-enlaceCancelar">Cancelar</a>
		</div>
	</div>
</div>
