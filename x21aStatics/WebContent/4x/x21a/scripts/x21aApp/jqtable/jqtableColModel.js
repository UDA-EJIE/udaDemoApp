 ...
 */
	...
	tableColModels = [
		...
		{ name: "nombre", index: "nombre", editable:true, obligatorio:true
			, formoptions:{rowpos:2, colpos:1}
		},
		{ name: "apellido1", index: "apellido1", editable:true, obligatorio:true
		...
		{ name: "fechaAlta",  index: "fecha_alta", editable:true, width: 120, obligatorio:true,
			rupType: "date",
			rwdClasses:"hidden-xs hidden-sm hidden-md",
			editoptions:{
