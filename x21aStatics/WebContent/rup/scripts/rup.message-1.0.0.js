...
(function ($) {
	...
	window.alert = function (text) {
        $.rup_messages("msgAlert", {title: $.rup.i18n.rup_message.alert, message: text});    
    };
	...
	$.rup_messages("extend", {
		msgError : function (properties) {
            ...
            self.dialog({
                ...
                modal: true,
                resizable: false,
                closeText: $.rup.i18n.rup_message.tituloError.cerrar,
                title: (properties.title === null || properties.title === "" ? $.rup.i18n.rup_message.tituloError: properties.title),
                close: function () {
                    self.dialog("destroy");
                    self.remove();
                    self = null;
                ...
                buttons: [{
                        text: $.rup.i18n.rup_message.aceptar,
                        click: function () { 
                            self.dialog("close"); 
                        }
                    }]
        ...
        msgConfirm : function (properties) {    
            ...
            self.dialog({
                    ...
                    resizable: false,
                    closeText: $.rup.i18n.rup_message.tituloError.cerrar,
                    title: (properties.title === null || properties.title === "" ?$.rup.i18n.rup_message.confirmacion: properties.title),
                    close: function () {
                        self.dialog("destroy");
                        self.remove();
                        self = null;
        ...
        msgOK : function (properties) {    
            ...
            self.dialog({
                    ...
                    resizable: false,
                    closeText: $.rup.i18n.rup_message.tituloError.cerrar,
                    title: (properties.title === null || properties.title === "" ? $.rup.i18n.rup_message.correct: properties.title),
                    close: function () {
                        self.dialog("destroy");
                        self.remove();
                        self = null;
        ...
        msgAlert : function (properties) {
            ...
            self.dialog({
                    ...
                    modal: true,
                    resizable: false,
                    closeText: $.rup.i18n.rup_global.cerrar,
                    title: (properties.title === null || properties.title === "" ? $.rup.i18n.rup_message.alert: properties.title),
                    close: function () {
                        self.dialog("destroy");
                        self.remove();
                        self = null;
	...
	$.rup_messages("extend", {
			...
			_createCloseLink : function (self) { //Crea el enlace de cerrar junto a la x de cerrar.
				var closeSpan = "<span id='closeText_" + self[0].id + "' style='float:right;font-size:0.85em;'>" + $.rup.i18n.rup_global.cerrar + "</span>", 
	            aClose = $("<a href='#'></a>")
	                    .attr("role", "button")
            ...
            //creamos el enlace
				var cancelHREF = $("<a href='#'></a>")
                        ...
                        .html($.rup.i18n.rup_global.cancel)
                        .click(function (event) {
                    self.dialog("close");
                    return false;
                });
