		...
		_create: function () {
			...
			if(LOGGED_USER !== ""){
				...
				if (this.options.logOutUrl !== undefined){
					this.element.append($("<div id='logOutDiv' class='rup-breadCrumb_logoutDiv'>").append($("<a>").addClass("rup-breadCrumb_cursorPointer").attr("logOutHref",this.options.logOutUrl).bind("click",
					...
					});}).html($.rup.i18nParse($.rup.i18n.base,"rup_breadCrumb.disconnect")).attr("id","logOutLink")));

					//this.element.append($("<a>").html($.rup.i18nParse($.rup.i18n.base,"rup_breadCrumb.disconnect")));
				}
