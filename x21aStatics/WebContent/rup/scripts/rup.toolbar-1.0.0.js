...
(function ($) {
	...
	$.rup_toolbar.extend({
		addButton : function (obj, json_i18n) { //añade a la toolbar un 'button'
			var boton = $("<button/>").text(json_i18n[obj.i18nCaption]).addClass("rup-toolbar_button");
		...
		addMButton : function (obj, json_i18n){ //añade a la toolbar un 'mbutton' (sin botones)
			...
			if (obj.id === undefined) {
				...
				boton = $("<a/>").attr("id", obj.id).text(json_i18n[obj.i18nCaption]).addClass("rup-toolbar_menuButton");
