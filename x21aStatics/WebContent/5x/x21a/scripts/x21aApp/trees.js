...
$(function () {
    ...
    $('#specificStyleDemo').rup_tree({
        'themes': {
            'theme': 'default',
            'url': window.STATICS + '/x21a/styles/tree/themes/default/style.css'
        }
    });
    ...
    $('#changeTheme').click(function () {
        ...
        if (type === 'rup-default') {
            $('#changeViewDemo').rup_tree('set_theme', 'apple', window.STATICS + '/x21a/styles/tree/themes/apple/style.css');
        } else if (type === 'apple') {
            $('#changeViewDemo').rup_tree('set_theme', 'default', window.STATICS + '/x21a/styles/tree/themes/default/style.css');
        } else if (type === 'default') {
            $('#changeViewDemo').rup_tree('set_theme', 'classic', window.STATICS + '/x21a/styles/tree/themes/classic/style.css');
        } else {
