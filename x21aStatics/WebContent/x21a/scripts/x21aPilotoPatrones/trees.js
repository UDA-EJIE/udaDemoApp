...
jQuery(document).ready(function(){
	...
	$("#specificStyleDemo").rup_tree({
		"themes" : {
			"theme" : "default",
			"url" : STATICS+"/x21a/styles/tree/themes/default/style.css"
		}
	});
...
//		"deselect_node_event" : function(){var nodes = "";$.each($("#selectDemo").rup_tree("get_selected"), function(key, value){nodes = nodes + $(value).attr("id")+ " ";}); alert("Evento deselect<br>Nodos seleccionados: "+ nodes);}
	...
	$("#sortDemo").rup_tree({
		"core" : { "initially_open" : [ "node121","node112" ] },
		"sort" : {
			"enable" : true
		}
	});
	...
	$("#checkboxDemo").rup_tree({
		"core" : { "initially_open" : [ "node121","node112","node113" ] },
		"checkbox" : {
			"enable" : true
		}
	});
...
//					"paste" : false,
			...
			"items" : {
				...
				"exampleItem" : {
					...
					"action"            : function (obj) { $("#contextmenuDemo").rup_tree("rename",obj); },
...
//						}
	...
	$("#uniqueDemo").rup_tree({
		"core" : { "initially_open" : ["nodeC","nodeAC"] },
		"contextmenu" : {
			"enable" : true
		},
		"unique" : {
