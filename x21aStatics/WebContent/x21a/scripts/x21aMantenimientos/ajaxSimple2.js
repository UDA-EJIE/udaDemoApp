...
//			Definición para rup_combo 
	...
	$("#simple_GRID_ajax_simple2").rup_maint({
		jQueryGrid: "GRID_ajax_simple2",
		primaryKey: "id",
		modelObject: "Usuario",
		detailButtons: $.rup.maint.detailButtons.SAVE,
		searchForm: "searchForm_GRID_ajax_simple2",
		showMessages: true
	});
	
	
	//Formulario de filtrado
	$('#ejie_search_GRID_ajax_simple2').rup_combo({
		source : [
		   {i18nCaption: "0", value:"0"},
		   {i18nCaption: "1", value:"1"}
		],
	...
	$("#fechaAlta_search_GRID_ajax_simple2").rup_date();
	$("#fechaBaja_search_GRID_ajax_simple2").rup_date();
