...
<div id="cabecera" class="cabecera" style="margin-bottom: 2em;" >
	<div style="float: left; margin-top:-1.5em;margin-bottom:1em;" >
		...
		<a href="${urlHashtag}" id="themeroller" ></a>
		<a href="${urlHashtag}" id="borrar_themeroller" style="display: none;">Borrar ThemeRoller<img src="${staticsUrl}/x21a/images/icons/trash.png"/></a>
	</div>
	<span style="font-size: 2em;color: #000000;margin-left: 1em; "><spring:message code="cabeceraPortal"/></span>
	<spring:url value="<%= request.getContextPath()%>/" var="urlHeader" htmlEscape="true"/>
	<a href="${urlHeader}" style="float: right; margin-top:-2em;">
