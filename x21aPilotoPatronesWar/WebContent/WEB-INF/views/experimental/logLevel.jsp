...
<div id="table_div" class="rup-table-container">
	...
	<div id="table_filter_div" class="rup-table-filter">
		<form:form modelAttribute="randomForm" id="table_filter_form">
			...
			<fieldset id="table_filter_fieldset" class="rup-table-filter-fieldset">
				<div class="formulario_columna_cnt">
					<div class="floating_left_pad_right one-column">
						...
						<form:input path="nameLog" class="formulario_linea_input" id="name_filter_table" />
					</div>
					<div class="floating_left_pad_right one-column">
						<label for="level_detail_table"><spring:message code="level" />:</label>
						<form:select path="levelLog" class="formulario_linea_input" id="level_filter_table" />
					</div>
	...
	<div class="ui-dialog-content ui-widget-content" >
		<form:form modelAttribute="randomForm" id="table_detail_form">
			...
			<div class="floating_left_pad_right">
				<div class="floating_left_pad_right one-column">
					<label for="name_detailForm_table"><spring:message code="name" />:</label>
					<form:input path="nameLog" class="formulario_linea_input" id="name_detail_table" />
				</div>
				<div class="floating_left_pad_right one-column">
					<label for="level_detail_table"><spring:message code="level" />:</label>
					<form:select path="levelLog" class="formulario_linea_input" id="level_detail_table" />
				</div>
