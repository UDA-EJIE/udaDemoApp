...
public class ProvinciaController  {
	...
	public ModelAndView getCreateForm(Model model) {
		...
		return new ModelAndView("provincia", "model", model);
	}
...
@RequestParam(value = "css", required = false) String css,
			...
			try{
			    ...
			    if (request.getHeader("JQGridModel") != null &&  request.getHeader("JQGridModel").equals("true")) {
			        ...
			        Long total =  getAllCount(filterProvincia, request);
	...
	@RequestParam(value = "provincia", required = false) Provincia  filterProvincia, HttpServletRequest request) {
	    try {
			return provinciaService
					.findAllCount(filterProvincia != null ? filterProvincia
							: new Provincia ());
		} catch (Exception e) {
    ...
    public @ResponseBody Provincia edit(@RequestBody Provincia provincia, HttpServletResponse response) {		
		try {
