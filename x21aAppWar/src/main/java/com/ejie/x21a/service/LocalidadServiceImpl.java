...
public class LocalidadServiceImpl implements LocalidadService {
	...
	@Override
	public TableResponseDto<Localidad> filter(Localidad filterLocalidad, TableRequestDto tableRequestDto, Boolean startsWith) {
		...
		TableResponseDto<Localidad> localidadDto = new TableResponseDto<Localidad>(tableRequestDto, recordNum, listaLocalidad);
