...
public  class NoraAutonomiaServiceImpl implements NoraAutonomiaService {
	...
	public List<NoraAutonomia> findAll(NoraAutonomia autonomia, TableRequestDto tableRequestDto) {
		return (List<NoraAutonomia>) this.noraAutonomiaDao.findAll(autonomia, tableRequestDto);
	}
	...
	public List<NoraAutonomia> findAllLike(NoraAutonomia autonomia, TableRequestDto tableRequestDto, Boolean startsWith) {
		return (List<NoraAutonomia>) this.noraAutonomiaDao.findAllLike(autonomia, tableRequestDto, startsWith);
	}
