...
public class TableLocalidadController {
	...
	public String getTableLocalidadEditForm (
		...
		if (pkValueIdPadre != null) {
			model.addAttribute("pkValueIdPadre", pkValueIdPadre);
		}
	...
	public @ResponseBody TableResponseDto<Localidad> filter(
	...
	public @ResponseBody List<Localidad> getClipboardReport(
		...
		return this.localidadService.getDataForReports(filterLocalidad, tableRequestDto);
	}
