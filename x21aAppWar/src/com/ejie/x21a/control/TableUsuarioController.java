...
public class TableUsuarioController {
	...
	public @ResponseBody List<AutocompleteComboGenericPOJO> getApellidos (
		...
		apellidos.add(new AutocompleteComboGenericPOJO("Garc�a", "Garc�a"));
		apellidos.add(new AutocompleteComboGenericPOJO("Gonz�lez", "Gonz�lez"));
		apellidos.add(new AutocompleteComboGenericPOJO("Fern�ndez", "Fern�ndez"));
		apellidos.add(new AutocompleteComboGenericPOJO("Rodr�guez", "Rodr�guez"));
		apellidos.add(new AutocompleteComboGenericPOJO("L�pez", "L�pez"));
		apellidos.add(new AutocompleteComboGenericPOJO("Mart�nez", "Mart�nez"));
		apellidos.add(new AutocompleteComboGenericPOJO("S�nchez", "S�nchez"));
		apellidos.add(new AutocompleteComboGenericPOJO("P�rez", "P�rez"));
		apellidos.add(new AutocompleteComboGenericPOJO("G�mez", "G�mez"));
		apellidos.add(new AutocompleteComboGenericPOJO("Mart�n", "Mart�n"));
		apellidos.add(new AutocompleteComboGenericPOJO("Jim�nez", "Jim�nez"));
		apellidos.add(new AutocompleteComboGenericPOJO("Ruiz", "Ruiz"));
		apellidos.add(new AutocompleteComboGenericPOJO("Hern�ndez", "Hern�ndez"));
		apellidos.add(new AutocompleteComboGenericPOJO("D�az", "D�az"));
		apellidos.add(new AutocompleteComboGenericPOJO("Moreno", "Moreno"));
		apellidos.add(new AutocompleteComboGenericPOJO("�lvarez", "�lvarez"));
		apellidos.add(new AutocompleteComboGenericPOJO("Mu�oz", "Mu�oz"));
		apellidos.add(new AutocompleteComboGenericPOJO("Romero", "Romero"));
		apellidos.add(new AutocompleteComboGenericPOJO("Alonso", "Alonso"));
		apellidos.add(new AutocompleteComboGenericPOJO("Guti�rrez", "Guti�rrez"));
		...
		apellidos.add(new AutocompleteComboGenericPOJO("Dom�nguez", "Dom�nguez"));
		apellidos.add(new AutocompleteComboGenericPOJO("V�zquez", "V�zquez"));
