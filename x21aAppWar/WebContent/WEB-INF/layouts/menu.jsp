	  ...
	  <li class="nav-item dropdown">
	    ...
	    <div class="dropdown-menu" aria-labelledby="datatableDropdown">
	    	...
	    	<div class="dropdown-submenu" >
              ...
              <div class="dropdown-menu menu-right">
			  	<a class="dropdown-item" href="/x21aAppWar/tableLegacy/filtroSimple"><spring:message code="tablaLegacy.filtroSimple" /></a>
		        <a class="dropdown-item" href="/x21aAppWar/tableLegacy/formEditAutogenerated"><spring:message code="tablaLegacy.edicionFormularioAuto" /></a>
		        <a class="dropdown-item" href="/x21aAppWar/tableLegacy/formEdit"><spring:message code="tablaLegacy.edicionFormulario" /></a>
		        <a class="dropdown-item" href="/x21aAppWar/tableLegacy/formEditMultiselection"><spring:message code="tablaLegacy.edicionFormularioMultiseleccion" /></a>
		        ...
		        <a class="dropdown-item" href="/x21aAppWar/tableLegacy/tableRadiobutton"><spring:message code="tablaLegacy.tablaRadioButton" /></a>
