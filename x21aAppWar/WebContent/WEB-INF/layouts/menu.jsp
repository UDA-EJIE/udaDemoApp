            ...
            <nav class="rup-navbar navbar">
                ...
                <div id="navbarResponsive" class="collapse navbar-toggleable-md">
                    ...
                    <ul class="nav navbar-nav">
                            ...
                            <div class="dropdown-menu" aria-labelledby="responsiveNavbarDropdown">
                                ...
                                <div class="dropdown-submenu">
                                    ...
                                    <div class="dropdown-menu menu-right">
                                        ...
                                        <a class="dropdown-item" href="/x21aAppWar/patrones/maintTab">
                                            <spring:message code="maintTab" />
                                        </a>
                                        <a class="dropdown-item" href="/x21aAppWar/patrones/tabsScrollable">
                                ...
                                <div class="dropdown-submenu">
                                    ...
                                    <div class="dropdown-menu menu-right">
                                        ...
                                        <a class="dropdown-item" href="/x21aAppWar/patrones/wizard_includeFile">
                                            <spring:message code="wizardB" htmlEscape="true" />
                                        </a>
                                        <a class="dropdown-item" href="/x21aAppWar/patrones/wizard_jspInclude">
                                            <spring:message code="wizardC" htmlEscape="true" />
                                        </a>
                                        <a class="dropdown-item" href="/x21aAppWar/patrones/wizard_jstlImport">
                                            <spring:message code="wizardD" htmlEscape="true" />
                                        </a>
                                        <a class="dropdown-item" href="/x21aAppWar/patrones/wizard_dinamico">
                                ...
                                <div class="dropdown-submenu">
                                    ...
                                    <div class="dropdown-menu menu-right">
                                        ...
                                        <a class="dropdown-item" href="/x21aAppWar/patrones/comboEnlazadoSimple">
                                            <spring:message code="comboEnlazadoSimple" />
                                        </a>
                                        <a class="dropdown-item" href="/x21aAppWar/patrones/comboEnlazadoMultiple">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="dashboardDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <spring:message code="dashboard" />
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dashboardDropdown">
                                <a class="dropdown-item" href="/x21aAppWar/dashboard/dashboardSimple">
                                    <spring:message code="dashboard.simple.title" />
                                </a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
