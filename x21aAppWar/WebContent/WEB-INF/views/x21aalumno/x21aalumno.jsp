...
<table id="x21aAlumno" class="tableFit table-striped table-bordered table-material" 
	...
	<thead>
		<tr>
			...
			<th data-col-prop="provinciaId" data-col-sidx="provinciaId" >provinciaId</th>
			<th data-col-prop="comarcaId" data-col-sidx="COMARCA_ID" >comarcaId</th>
			<th data-col-prop="localidadId" data-col-sidx="localidadId" >localidadId</th>
			<th data-col-prop="municipioId" data-col-sidx="MUNICIPIOId" >municipioId</th>
	    </tr>
	</thead>
</table>
