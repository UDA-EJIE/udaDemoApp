<form id="usuario_filter_form">
  ...
  <fieldset id="usuario_filter_fieldset" class="rup-table-filter-fieldset">
    ...
    <div id="usuario_filter_buttonSet" class="right_buttons">
        ...
        <a id="usuario_filter_cleanLink" href="javascript:void(0)" class="rup-enlaceCancelar">Limpiar</a>
        <button id="usuario_filter_filterButton" type="button" class="ui-button ui-widget ui-state-default ui-corner-all" >Filtrar</button>
    </div>
  </fieldset>
</form>