...
<h2><spring:message code="patron.formulario.titulo" /></h2>
...
<fieldset class="alumnoFieldset">
	<legend><spring:message code="patron.formulario.funcionesAjaxForm" /></legend>
		<div>
			<span><spring:message code="patron.formulario.funcionesAjaxForm.formSerialize" /></span>
			<code>
				<br /><spring:message code="patron.formulario.funcionesAjaxForm.formSerialize.ejemplo" /><br />
			</code>
			<button id="botonFormSerialize"><spring:message code="patron.formulario.funcionesAjaxForm.formSerialize" /></button>
		...
		<div>
			...
			<code>
				<br /><spring:message code="patron.formulario.funcionesAjaxForm.fieldSerialize.ejemplo" /><br />
			</code>
			<button id="botonFieldSerialize"><spring:message code="patron.formulario.funcionesAjaxForm.fieldSerialize" /></button>
		...
		<div>
			...
			<code>
				<br /><spring:message code="patron.formulario.funcionesAjaxForm.fieldValue.ejemplo" /><br />
			</code>
			<button id="botonFieldValue"><spring:message code="patron.formulario.funcionesAjaxForm.fieldValue" /></button>
			<div id="resultadoFieldValue" class="col1"></div>
		</div>
		<div>
			<span><spring:message code="patron.formulario.funcionesAjaxForm.resetForm" /></span>
			<code>
				<br /><spring:message code="patron.formulario.funcionesAjaxForm.resetForm.ejemplo" /><br />
			</code>
			<button id="botonResetForm"><spring:message code="patron.formulario.funcionesAjaxForm.resetForm" /></button>
			<div id="resultadoResetForm" class="col1"></div>
		</div>
		<div>
			<span><spring:message code="patron.formulario.funcionesAjaxForm.clearForm" /></span>
			<code>
				<br /><spring:message code="patron.formulario.funcionesAjaxForm.clearForm.ejemplo" /><br />
			</code>
			<button id="botonClearForm"><spring:message code="patron.formulario.funcionesAjaxForm.clearForm" /></button>
			<div id="resultadoClearForm" class="col1"></div>
		</div>
		<div>
			<span><spring:message code="patron.formulario.funcionesAjaxForm.clearFields" /></span>
			<code>
				<br /><spring:message code="patron.formulario.funcionesAjaxForm.clearFields.ejemplo" /><br />
			</code>
			<button id="botonClearFields"><spring:message code="patron.formulario.funcionesAjaxForm.clearFields" /></button>
...
<div id="divMultiplesEntidades">
	<form id="formMultientidades" action='${pageContext.request.contextPath}/patrones/form/multientidades' method="post">
		<fieldset class="alumnoFieldset">
			<legend><spring:message code="patron.formulario.envioVariasEntidades" /></legend>
			
			<span><spring:message code="patron.formulario.envioVariasEntidades.descripcion" /></span>
			
			<fieldset class="alumnoFieldset">
				<legend><spring:message code="alumno" /></legend>
				<div class="two-col" >
				    <div class="col1">
			...
			<fieldset class="alumnoFieldset">
				<legend><spring:message code="departamento" /></legend>
				<div class="two-col" >
				    <div class="col1">
		...
		<input type="submit" value="<spring:message code="patron.formulario.enviarMultientidad" />" />
		</fieldset>
	</form>
	...
	<form id="formMultientidadesMismoTipo" action='${pageContext.request.contextPath}/patrones/form/multientidadesMismoTipo' method="post">
		<fieldset class="alumnoFieldset">
			<legend><spring:message code="patron.formulario.envioVariasEntidadesIguales" /></legend>
			
			<span><spring:message code="patron.formulario.envioVariasEntidadesIguales.descripcion" /></span>
			
			<fieldset class="alumnoFieldset">
				<legend><spring:message code="comarca" /></legend>
				<div class="two-col" >
				    <div class="col1">
