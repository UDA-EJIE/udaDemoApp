...
<div id="tableDialog_div" class="rup-table-container">
	...
	<div id="tableDialog_filter_div" class="rup-table-filter">
		<form:form modelAttribute="randomForm" id="tableDialog_filter_form">
			...
			<fieldset id="tableDialog_filter_fieldset" class="rup-table-filter-fieldset">
				<div class="formulario_columna_cnt">
					...
					<div class="formulario_linea_izda_float"  style="clear:left">
						...
						<form:input path="rol" class="formulario_linea_input" id="rol_filter_tableDialog" />
					</div>
				</div>
...
<div id="tableDialog_detail_div" class="rup-table-formEdit-detail">
	...
	<div class="ui-dialog-content ui-widget-content" >
		<form:form modelAttribute="randomForm" id="tableDialog_detail_form">
			...
			<div class="floating_left_pad_right">
				<div class="floating_left_pad_right one-column">
					...
					<form:input path="id" class="formulario_linea_input" id="id_detailForm_tableDialog" />
				</div>
				<div class="floating_left_pad_right one-column">
					<label for="nombre_detail_tableDialog"><spring:message code="nombre" />:</label>
					<form:input path="nombre" class="formulario_linea_input" id="nombre_detail_tableDialog" />
				</div>
				<div class="floating_left_pad_right one-column">
					<label for="apellido1_detail_tableDialog"><spring:message code="apellido1" />:</label>
					<form:input path="apellido1" class="formulario_linea_input" id="apellido1_detail_tableDialog" />
				</div>
				<div class="floating_left_pad_right one-column">
					<label for="apellido2_detail_tableDialog"><spring:message code="apellido2" />:</label>
					<form:input path="apellido2" class="formulario_linea_input" id="apellido2_detail_tableDialog" />
				</div>
				<div class="floating_left_pad_right one-column">
					<label for="ejie_detail_tableDialog"><spring:message code="ejie" />:</label>
					<form:checkbox id="ejie_detail_tableDialog" path="ejie"  value="1"/>
				</div>
				<div class="floating_left_pad_right one-column">
					<label for="fechaAlta_detail_tableDialog"><spring:message code="fechaAlta" />:</label>
					<form:input path="fechaAlta" class="formulario_linea_input" id="fechaAlta_detail_tableDialog" />
				</div>
				<div class="floating_left_pad_right one-column" style="clear: left;">
					...
					<form:input path="fechaBaja" class="formulario_linea_input" id="fechaBaja_detail_tableDialog" />
				</div>
				<div class="floating_left_pad_right one-column">
					<label for="rol_detail_tableDialog"><spring:message code="rol" />:</label>
					<form:select id="rol_detail_tableDialog" path="rol" class="formulario_linea_input" />
				</div>
			</div>
		</form:form>
	</div>
	...
	<div class="rup-table-buttonpane ui-widget-content ui-helper-clearfix">
		<div class="ui-dialog-buttonset rup_jqtableEdit_buttonsContainerResposive">
			<button id="tableDialog_detail_button_save" class="btn btn-outline-primary rup_jqtableEdit_buttonsResposive" type="button">
				<spring:message code="save" />
			</button>
			<button id="tableDialog_detail_button_save_repeat" class="btn btn-outline-primary rup_jqtableEdit_buttonsResposive" type="button">
