...
<div id="fileupload_form">
	<form:form action="../upload/form" id="uploadForm" enctype="multipart/form-data" method="POST" modelAttribute="alumno">
		<fieldset style="border: 1px solid #DADADA;" id="fieldset_formulario">
			...
			<div class="row">
				<div class="col-md-12">Archivos adjuntos:</div>
			</div>
			<div class="row">
				<div class="col-md-12 ">
					<div class="rup-upload">
						<span class="btn btn-success fileinput-button">
							...
							<span>
								<spring:message code="upload.button.addFiles" />
							</span>
							<input id="file_form" type="file" name="foto" />
						</span>
