...
<section>
	...
	<div class="row">
	  <div class="col-12 col-md-8">
	  		...
	  		<div class="row">
	  			<div class="col-md-12">
	  				<form:form method="post" action="." modelAttribute="randomForm">
                    <input type='hidden' name='csrfmiddlewaretoken' value='XFe2rTYl9WOpV8U6X5CfbIuOZOELJ97S' />
                            

<!--                     <form  class="form-horizontal" method="post" > -->
					<form:form class="form-horizontal" method="post" modelAttribute="randomForm">
                        <input type='hidden' name='csrfmiddlewaretoken' value='XFe2rTYl9WOpV8U6X5CfbIuOZOELJ97S' />
                        <div id="div_id_select" class="mb-3 required">
                            ...
                            <div class="controls col-md-8 "  style="margin-bottom: 10px">
                                ...
                                <label class="radio-inline"><form:radiobutton path="select" id="id_select_2" value="P"  style="margin-bottom: 10px"/>Knowledge Provider </label>
                            </div>
                        </div> 
                        <div id="div_id_As" class="mb-3 required">
                        ...
                        <div id="div_id_username" class="mb-3 required">
                        ...
                        <div id="div_id_email" class="mb-3 required">
                        ...
                        <div id="div_id_password1" class="mb-3 required">
                            <label for="id_password1" class="control-label col-md-4  requiredField">Password<span class="asteriskField">*</span> </label>
                            <div class="controls col-md-8 "> 
                                <form:password class="input-md textinput textInput form-control" id="id_password1" path="password1" placeholder="Create a password" style="margin-bottom: 10px"/>
                            </div>
                        </div>
                        <div id="div_id_password2" class="mb-3 required">
                             <label for="id_password2" class="control-label col-md-4  requiredField"> Re:password<span class="asteriskField">*</span> </label>
                             <div class="controls col-md-8 ">
                                <form:password class="input-md textinput textInput form-control" id="id_password2" path="password2" placeholder="Confirm your password" style="margin-bottom: 10px"/>
                            </div>
                        </div>
                        <div id="div_id_name" class="mb-3 required"> 
                            <label for="id_name" class="control-label col-md-4  requiredField"> full name<span class="asteriskField">*</span> </label> 
                            <div class="controls col-md-8 "> 
                                <form:input class="input-md textinput textInput form-control" id="id_name" path="name" placeholder="Your Frist name and Last name" style="margin-bottom: 10px"/>
                            </div>
                        </div>
                        <div id="div_id_gender" class="mb-3 required">
                        ...
                        <div id="div_id_company" class="mb-3 required"> 
                        ...
                        <div id="div_id_catagory" class="mb-3 required">
                            <label for="id_catagory" class="control-label col-md-4  requiredField"> catagory<span class="asteriskField">*</span> </label>
                            <div class="controls col-md-8 "> 
                                 <form:input class="input-md textinput textInput form-control" id="id_catagory" path="category" placeholder="skills catagory" style="margin-bottom: 10px" type="text" />
                            </div>
                        </div> 
                        <div id="div_id_number" class="mb-3 required">
                        ...
                        <div id="div_id_location" class="mb-3 required">
