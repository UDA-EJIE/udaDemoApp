...
<div id="example_detail_div" class="rup-table-formEdit-detail">
	...
	<div class="rup-table-buttonpane ui-widget-content ui-helper-clearfix">
		<div class="ui-dialog-buttonset rup_datatableEdit_buttonsContainerResposive">
			<button id="example_detail_button_save" class="btn btn-outline-primary rup_datatableEdit_buttonsResposive" type="button">
				<spring:message code="save" />
			</button>
			<button id="example_detail_button_save_repeat" class="btn btn-outline-primary rup_datatableEdit_buttonsResposive" type="button">
				<spring:message code="saveAndContinue" />
			</button>
			<button id="example_detail_button_cancel" class="btn btn-outline-primary rup_datatableEdit_buttonsResposive" type="button">
