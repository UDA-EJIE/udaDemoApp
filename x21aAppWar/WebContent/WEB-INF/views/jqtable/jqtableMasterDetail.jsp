...
<h2>Comarca</h2>
	<div id="comarca_filter_div"  class="rup-table-filter">
		...
		<form:form id="comarca_filter_form" modelAttribute="comarca" method="post">
...
<div id="comarca_detail_div" class="rup-table-formEdit-detail">
	...
	<div class="ui-dialog-content ui-widget-content" >
		...
		<form:form id="comarca_detail_form" modelAttribute="comarca" method="put">
			...
			<div class="form-row">  
			    <div class="form-group fix-align col-sm">
					...
					<form:select path="provincia.code" class="rup-combo" id="provinciaRemote" />
			    </div>			    
...
<h2>Localidad</h2>
	...
	<div id="localidad_filter_div"  class="rup-table-filter">
		...
		<form:form id="localidad_filter_form" modelAttribute="localidad" method="post">
...
<div id="localidad_detail_div" class="rup-table-formEdit-detail">
	...
	<div class="ui-dialog-content ui-widget-content" >
		<form:form id="localidad_detail_form" modelAttribute="localidad" method="put">
