...
# ------------------------------------------------------------------
###
echo "Comienzo de actualización de base de datos x54j"
echo " "
...
sqlplus -s $USUARIO/$PASSWORD @/aplic/aa79b/scripts/X54J_P43.SQL
...
echo "Lanzando script /aplic/aa79b/scripts/AA79B_VERSION_3_9_23.SQL"
sqlplus -s $USUARIO/$PASSWORD @/aplic/aa79b/scripts/AA79B_VERSION_3_9_23.SQL
