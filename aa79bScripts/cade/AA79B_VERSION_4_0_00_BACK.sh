...
echo "Lanzando script /aplic/aa79b/scripts/AA79B_VERSION_4_0_00_R75B_BACK.sql"
sqlplus -s $USUARIO/$PASSWORD @/aplic/aa79b/scripts/AA79B_VERSION_4_0_00_R75B_BACK.sql
...
echo "Lanzando script /aplic/aa79b/scripts/AA79B_VERSION_4_0_00_BACK.SQL"
sqlplus -s $USUARIO/$PASSWORD @/aplic/aa79b/scripts/AA79B_VERSION_4_0_00_BACK.SQL
