...
echo "Lanzando script /aplic/aa79b/scripts/Cargas/AA79BMigracionR75.SQL"
sqlplus -s $USUARIO/$PASSWORD @/aplic/aa79b/scripts/Cargas/AA79BMigracionR75.SQL $ANYO $NUMEXP
