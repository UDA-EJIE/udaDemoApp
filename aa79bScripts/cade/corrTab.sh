...
echo "Lanzando script /aplic/aa79b/scripts/Cargas/CorreccionTareasDupTabla.SQL"
sqlplus -s $USUARIO/$PASSWORD @/aplic/aa79b/scripts/Cargas/CorreccionTareasDupTabla.SQL 
