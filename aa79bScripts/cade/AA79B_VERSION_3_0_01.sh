...
sqlplus -s $USUARIO/$PASSWORD @/aplic/aa79b/scripts/X54J_V3_0_01.sql
...
echo "Lanzando script /aplic/aa79b/scripts/AA79B_VERSION_3_0_01.SQL"
sqlplus -s $USUARIO/$PASSWORD @/aplic/aa79b/scripts/AA79B_VERSION_3_0_01.SQL
