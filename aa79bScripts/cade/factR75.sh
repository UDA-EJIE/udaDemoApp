...
echo "Lanzando script /aplic/aa79b/scripts/Cargas/CorreccionFacturadosR75.SQL"
sqlplus -s $USUARIO/$PASSWORD @/aplic/aa79b/scripts/Cargas/CorreccionFacturadosR75.SQL $ANYO $NUMEXP
