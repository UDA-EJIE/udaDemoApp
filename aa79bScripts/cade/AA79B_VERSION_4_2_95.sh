...
echo "Lanzando script /aplic/aa79b/scripts/X54J_V4_2_95.SQL"
sqlplus -s $USUARIO/$PASSWORD @/aplic/aa79b/scripts/X54J_V4_2_95.sql
...
echo "Lanzando script /aplic/aa79b/scripts/AA79B_VERSION_4_2_95.SQL"
sqlplus -s $USUARIO/$PASSWORD @/aplic/aa79b/scripts/AA79B_VERSION_4_2_95.SQL