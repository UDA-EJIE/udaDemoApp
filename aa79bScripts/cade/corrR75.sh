...
echo "Lanzando script /aplic/aa79b/scripts/Cargas/CorreccionTareasDuplicadasMIG.SQL"
sqlplus -s $USUARIO/$PASSWORD @/aplic/aa79b/scripts/Cargas/CorreccionTareasDuplicadasMIG.SQL $ANYO $NUMEXP
