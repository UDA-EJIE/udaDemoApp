...
function columnasPorExpedientes() {	 
    ...
    myGrid.jqGrid('showCol','tipoExpedienteDescEu');
...
function columnasPorTareas() {	  
    ...
    myGrid.jqGrid('hideCol','tipoExpedienteDescEu');
...
function columnasPorTramites() {	  
    var myGrid = $('#busquedaDatos');
    myGrid.jqGrid('showCol','anyoNumExpConcatenado');
    myGrid.jqGrid('hideCol','tipoExpedienteDescEu');
    myGrid.jqGrid('showCol','vipEntidadGestorEu');
    myGrid.jqGrid('hideCol','fechaHoraAlta');
    myGrid.jqGrid('hideCol','fechaHoraFin');
    myGrid.jqGrid('hideCol','conformidad');
    myGrid.jqGrid('hideCol','sinAsignar');
    myGrid.jqGrid('showCol','bitacoraExpediente.subsanacionExp.tipoRequerimientoDescEu');
    myGrid.jqGrid('showCol','bitacoraExpediente.subsanacionExp.fechaHoraLimite');
    myGrid.jqGrid('showCol','bitacoraExpediente.subsanacionExp.estadoDescEu');
    myGrid.jqGrid('hideCol', 'tarea.tipoTarea.descEu015');
    myGrid.jqGrid('hideCol', 'gestorExpediente.solicitante.nombreCompleto');
    myGrid.jqGrid('hideCol', 'tarea.fechaHoraAsignacion');
    myGrid.jqGrid('hideCol', 'tarea.estadoAsignadoDesc');
...
function mostrarTabla(){
	 $('#busquedaDatos').jqGrid("sortGrid", "anyoNumExpConcatenado", true);
	 ...
	 if(tipoFiltro === "expedientes" || tipoFiltro === "expedientesSin"){
		 ...
		 columnasPorTareas();
		 $('#leyendaUrgente').hide();
	 }else if(tipoFiltro === "tramites"){
		 $("#busquedaDatos").jqGrid('groupingRemove');
		 columnasPorTramites();
		 $('#leyendaUrgente').hide();
		 $('#leyendaRecurso').hide();
	 }
...
jQuery(function($){
	...
	$("#busquedaDatos_filter_form").rup_validate({
	 ...
	 $('#busquedaDatos_Boton_filtro').click(function(event){
