function mostrarContactoFacturacion(){
	...
	mostrarCapaExpedienteMYO('divContactoFacturacion');
...
//     					$('#dniContacto058_detail_table_label').val($("#contactofacturacionexp").rup_table("getCol", id, "contacto.nombreCompleto"));
//    					$("#dniContacto058_detail_table").rup_autocomplete("set", $("#contactofacturacionexp").rup_table("getCol", id, "dniContacto058"), $("#contactofacturacionexp").rup_table("getCol", id, "contacto.nombreCompleto"));    								
//    					$('#dniContacto058_detail_table_label').attr('readonly', false);
...
//      					savedData["dniContacto058"]=$('#dniContacto058_detail_table').val(); 
			 ...
			 addOptions: {								 		
				 beforeShowForm: function(){
					...
					jQuery('input[name=tipoEntidadFact]:first').click();
//					$('#dniContacto058_detail_table_label').attr('readonly', true);
