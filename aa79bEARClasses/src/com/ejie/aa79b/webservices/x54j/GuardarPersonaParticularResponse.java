...
@XmlRootElement(name = "guardarPersonaParticularResponse", namespace = "http://www.ejie.es/webServiceEJB/x54jPermisosWSWar")
public class GuardarPersonaParticularResponse {
