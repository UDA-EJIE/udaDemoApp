 ...
 *
 */
public class DatosPagoProveedorTareaExcelRowMapper implements RowMapper<DatosPagoProveedores> {
	...
	public DatosPagoProveedores mapRow(ResultSet resultSet, int rowNum) throws SQLException {
		...
		return queryUtils.getDatosPagoProveedorTareas(resultSet, true);
	}
}
