 ...
 *
 */
public class LotesRowMapper implements RowMapper<Lotes> {
	...
	public Lotes mapRow(ResultSet resultSet, int rowNum) throws SQLException {
		...
		lotes.setFechaFin(resultSet.getDate("FECHAFIN"));
		...
		lotes.setIndTramitacionRapida(resultSet.getString("IND_TRAMITACION_RAPIDA"));
		return lotes;
	}
