...
public class AA79bDocumentoTareaOrigenNoConformidadTraduccionRowMapper implements RowMapper<Aa79bDocumentoTarea> {
	...
	public Aa79bDocumentoTarea mapRow(ResultSet resultSet, int arg1) throws SQLException {
		...
		Aa79bDocumentoTareaAdjunto documentoTareaSubsanado = new Aa79bDocumentoTareaAdjunto();
		documentoTareaSubsanado.setIdFichero(resultSet.getBigDecimal(DBConstants.IDFICHEROSUBSANADO));
		documentoTareaSubsanado.setEncriptado(resultSet.getString(DBConstants.INDENCRIPTADODOCSUBS));
		documentoTareaSubsanado.setOid(resultSet.getString(DBConstants.OIDFICHERODOCSUBS));
		documentoTareaSubsanado.setTitulo(resultSet.getString(DBConstants.TITULODOCSUBSANADO));
		documentoTareaSubsanado.setNombre(resultSet.getString("NOMBREDOCSUBSANADO"));
