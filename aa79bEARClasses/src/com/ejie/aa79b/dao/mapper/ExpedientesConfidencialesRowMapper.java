...
public class ExpedientesConfidencialesRowMapper implements RowMapper<Expediente> {
	...
	public Expediente mapRow(ResultSet resultSet, int rowNum) throws SQLException {
		...
		expedienteTradRev.setFechaFinalSolic(resultSet.getDate(DBConstants.FECHAFINALIZO));
		expedienteTradRev.setHoraFinalSolic(resultSet.getString(DBConstants.HORAFINALIZO));
