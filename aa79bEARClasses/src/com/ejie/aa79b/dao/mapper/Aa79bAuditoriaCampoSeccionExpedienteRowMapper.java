...
public class Aa79bAuditoriaCampoSeccionExpedienteRowMapper implements RowMapper<Aa79bAuditoriaCampoSeccionExpediente> {

	@Override
	public Aa79bAuditoriaCampoSeccionExpediente mapRow(ResultSet rs, int arg1) throws SQLException {
		Aa79bAuditoriaCampoSeccionExpediente audiCampoSeccExp = new Aa79bAuditoriaCampoSeccionExpediente();
