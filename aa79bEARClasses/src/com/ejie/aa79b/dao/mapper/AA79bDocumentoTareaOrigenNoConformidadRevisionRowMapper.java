...
public class AA79bDocumentoTareaOrigenNoConformidadRevisionRowMapper implements RowMapper<Aa79bDocumentoTarea> {
	...
	public Aa79bDocumentoTarea mapRow(ResultSet resultSet, int arg1) throws SQLException {
		...
		Aa79bFicheroDocExp ficheroSubsanado = new Aa79bFicheroDocExp();
		ficheroSubsanado.setIdDocRel(resultSet.getBigDecimal(DBConstants.IDFICHEROSUBSANADO));
		ficheroSubsanado.setEncriptado(resultSet.getString(DBConstants.INDENCRIPTADODOCSUBS));
		ficheroSubsanado.setOid(resultSet.getString(DBConstants.OIDFICHERODOCSUBS));
		ficheroSubsanado.setTitulo(resultSet.getString(DBConstants.TITULODOCSUBSANADO));
		ficheroSubsanado.setNombre(resultSet.getString("NOMBREDOCSUBSANADO"));
		...
		documentoTareaAdjunto.setNombre(resultSet.getString("NOMBREFICHREV"));
