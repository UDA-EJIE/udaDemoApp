...
public class Aa79bTradosExp implements Serializable {
	...
	/**
	 * @param numPalConcor084090
	 *            the numPalConcor084090 to set
	 */
	...
	/**
	 * @param numPalConcor8594090
	 *            the numPalConcor8594090 to set
	 */
	...
	/**
	 * @param numPalConcor95100090
	 *            the numPalConcor95100090 to set
	 */
	...
	public String toString() {
		return "Aa79bTradosExp [id=" + this.id + ", idFicheroTrados=" + this.idFicheroTrados + ", indVisible=" + this.indVisible
