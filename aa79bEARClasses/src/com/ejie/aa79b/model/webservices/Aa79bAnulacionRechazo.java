 ...
 * @author javarona
 */
public class Aa79bAnulacionRechazo implements Serializable {
	...
	public String toString() {
		return "Aa79bAnulacionRechazo [observaciones=" + observaciones + ", motivoDescEu=" + motivoDescEu
				+ ", motivoDescEs=" + motivoDescEs + "]";
	}
