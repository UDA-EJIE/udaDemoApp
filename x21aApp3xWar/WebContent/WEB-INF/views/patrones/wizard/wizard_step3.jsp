...
<fieldset>
	...
	<label for="desde">Fecha desde</label><label for="desde" id="intervalo-mask"/></label>: <form:input id="desde" path="desde"/> 
	<label for="hasta">hasta: </label><form:input id="hasta" path="hasta"/>
	<br/><br/>
