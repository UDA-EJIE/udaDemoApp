...
<form:form modelAttribute="randomForm" id="wizardForm">
	<fieldset>
		...
		<label for="username">Usuario</label> <form:input id="username" path="username" /> <br/><br/>
		<label for="password">Password</label> <form:password id="password" path="password" /> <br/><br/>
	...
	<fieldset>
		...
		<label for="desde">Fecha desde</label><label for="desde" id="intervalo-mask"/></label>: <form:input type="text" id="desde" path="desde"/> 
		<label for="hasta">hasta: </label><form:input type="text" id="hasta" path="hasta"/>
		<br/><br/>
		<label for="hora_entrada">Horario desde</label><label for="hora_entrada" id="hora-mask"></label>: <form:input id="hora_entrada" path="hora_entrada" />
		<label for="hora_entrada">hasta: </label><form:input id="hora_salida" path="hora_salida" />
		<br/><br/>
		<label for="dias">Días de trabajo</label>
		<form:select path="" id="dias"/>
		<br/><br/>
		<label for="cliente">Meses de trabajo en cliente</label>
		<form:select path=""id="cliente"/>
		<br/><br/>
		<div id="meses">
