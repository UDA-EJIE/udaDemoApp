	...
	<div id="tableDialog_detail_div" class="rup-table-formEdit-detail">
			...
			<form:form modelAttribute="usuario" id="tableDialog_detail_form">
				...
				<div class="form-row">
					<div class="form-group fix-align col-sm">
						...
						<form:checkbox id="ejie_detail_table" class="formulario_linea_input form-control" value="1" path="ejie" />
					</div>
					<div class="form-group fix-align col-sm">
		...
		<div class="rup-table-buttonpane ui-widget-content ui-helper-clearfix">
			<div class="ui-dialog-buttonset rup_tableEdit_buttonsContainerResposive">
				<button id="tableDialog_detail_button_save" class="btn btn-outline-primary rup_tableEdit_buttonsResposive fix-editForm-buttons-align" type="button">
					<spring:message code="save" />
				</button>
				<button id="tableDialog_detail_button_save_repeat" class="btn btn-outline-primary rup_tableEdit_buttonsResposive fix-editForm-buttons-align" type="button">
