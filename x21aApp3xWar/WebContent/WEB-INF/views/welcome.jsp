		...
		<div class="col-12">
			<h1>
				<img alt="El contenido estático no está correctamente desplegado."
					src="${staticsUrl}/rup/css/images/uda_logo.png" /> v3.7.3
	...
	<div class="row">
		<div class="col-12">
			<section id="mainContent">
				...
				<p>
					<spring:url value="${staticsUrl}/rup/css/images/uda-mini-micro2.png" var="urlMinMicrImage2" htmlEscape="true"/>
					<a target="_blank"
						href="${urlMinMicrImage2}"><img
						style="max-width: 100%;"
