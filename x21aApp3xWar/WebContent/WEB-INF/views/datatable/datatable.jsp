...
<form:form modelAttribute="options" id="example_tableConfiguration">
		...
		<div class="row">
	          ...
	          <div class="col-sm-10">
	              <div class="form-check custom-control custom-checkbox pluginsControl">
	                  <form:checkbox id="editForm" path="" class="custom-control-input" value="0"/>
	                  <label for="editForm" class="custom-control-label">Edición en Formulario</label>
	              </div>
	              <div class="form-check custom-control custom-checkbox pluginsControl">
	                  <form:checkbox id="colReorder" path="" class="custom-control-input" value="1"/>
	                  <label for="colReorder" class="custom-control-label">Col Reorder</label>
	              </div>
	              <div class="form-check custom-control custom-checkbox pluginsControl">
	                  <form:checkbox id="seeker" path="" class="custom-control-input" value="2"/>
	                  <label for="seeker" class="custom-control-label">Seeker</label>
	              </div>
	              <div class="form-check custom-control custom-checkbox pluginsControl">
	                  <form:checkbox id="buttons" path="" class="custom-control-input" value="3"/>
	                  <label for="buttons" class="custom-control-label">Botones</label>
	              </div>
	              <div class="form-check custom-control custom-checkbox pluginsControl">
	                  <form:checkbox id="groups" path="" class="custom-control-input" value="4"/>
	                  <label for="groups" class="custom-control-label">Agrupamiento</label>
	              </div>
	              <div class="form-check custom-control custom-checkbox pluginsControl">
	                  <form:checkbox id="multiFilter" path="" class="custom-control-input" value="5"/>
	                  <label for="multiFilter" class="custom-control-label">MultiFilter</label>
	              </div>
	              <div class="form-check custom-control custom-checkbox pluginsControl">
	                  <form:checkbox id="inlineEdit" path="" class="custom-control-input" value="6"/>
	...
	<fieldset class="form-group">
		<div class="row">
			...
			<div class="col-sm-10">
			    <div class="form-check custom-control custom-radio pluginsControl">
			        <form:radiobutton id="multiSelection" class="custom-control-input" path="example_seleccionTabla" value="7"/>
			        <label for="multiSelection" class="custom-control-label">Multiselección</label>
			    </div>
		        <div class="form-check custom-control custom-radio pluginsControl">
		            <form:radiobutton id="selection" class="custom-control-input"  path="example_seleccionTabla" value="8"/>
		            <label for="selection" class="custom-control-label">Selección Simple</label>
		        </div>
		        <div class="form-check custom-control custom-radio pluginsControl">
		            <form:radiobutton id="noSelection" class="custom-control-input"  path="example_seleccionTabla" value="9"/>
  	...
  	<fieldset class="form-group">		    
		<div class="row">
	          ...
	          <div class="col-sm-10">
	              <div class="form-check custom-control custom-checkbox pluginsControl">
	                  <form:checkbox id="triggers" path="" class="custom-control-input" value="10"/>
	                  <label for="triggers" class="custom-control-label">Activar Triggers en Consola</label>
	              </div>
	              <div class="form-check custom-control custom-checkbox pluginsControl">
	               <form:checkbox id="multiPart" path="" class="custom-control-input" value="10"/>
