...
public interface JQGridLocalidadDao {
    ...
    List<TableRowDto<Localidad>> reorderSelection(Localidad localidad, JQGridRequestDto jqGridRequestDto, Boolean startsWith);
