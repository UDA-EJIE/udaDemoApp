...
public class PerfilUsuarioDaoImpl implements PerfilUsuarioDao {
	...
	private RowMapper<PerfilUsuario> rwMap = new RowMapper<PerfilUsuario>() {
		public PerfilUsuario mapRow(ResultSet resultSet, int rowNum) throws SQLException {
           return new PerfilUsuario(
               resultSet.getBigDecimal("ID"), resultSet.getString("USERID"), resultSet.getString("PASS"), resultSet.getString("ACTIVO"), resultSet.getString("TIPO"), resultSet.getClob("DESCRIPCION"), resultSet.getTimestamp("FECHAALTA"), resultSet.getDate("FECHABAJA"), resultSet.getTimestamp("HORAENTRADA"), new Usuario(resultSet.getString("UsuarioID"), resultSet.getString("UsuarioNOMBRE"), resultSet.getString("UsuarioAPELLIDO1"), resultSet.getString("UsuarioAPELLIDO2"), resultSet.getString("UsuarioEJIE"), resultSet.getDate("UsuarioFECHAALTA"), resultSet.getDate("UsuarioFECHABAJA")), new Localidad(resultSet.getBigDecimal("LocalidadCODE"), resultSet.getString("LocalidadDESCES"), resultSet.getString("LocalidadDESCEU"), resultSet.getString("LocalidadCSS"), new Comarca(resultSet.getBigDecimal("LocalidadCODECOMARCA"), null, null, null, null, null)), new Comarca(resultSet.getBigDecimal("ComarcaCODE"), resultSet.getString("ComarcaDESCES"), resultSet.getString("ComarcaDESCEU"), resultSet.getString("ComarcaCSS"), new Provincia(resultSet.getBigDecimal("ComarcaCODEPROVINCIA"), null, null, null, null)), new Provincia(resultSet.getBigDecimal("ProvinciaCODE"), resultSet.getString("ProvinciaDESCES"), resultSet.getString("ProvinciaDESCEU"), resultSet.getString("ProvinciaCSS"))
           ); } } ;
    ...
    public PerfilUsuario update(PerfilUsuario perfilusuario) {
		String query = "UPDATE PERFIL_USUARIO SET ID_USUARIO=?,CODE_LOCALIDAD=?,CODE_COMARCA=?,CODE_PROVINCIA=?,USER_ID=?,PASS=?,ACTIVO=?,TIPO=?,DESCRIPCION=?,FECHA_ALTA=?,FECHA_BAJA=?,HORA_ENTRADA=? WHERE ID=?";
				Object getUsuarioIdAux=null;
				if (perfilusuario.getUsuario()!= null   && perfilusuario.getUsuario().getId()!=null ){
					getUsuarioIdAux=perfilusuario.getUsuario().getId();
				}
