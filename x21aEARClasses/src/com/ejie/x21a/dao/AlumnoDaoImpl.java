...
//					"IMAGEN"));
	...
	public Alumno find(Alumno alumno) {
		...
		String query = "SELECT t1.ID ID, t1.USUARIO USUARIO, t1.PASSWORD PASSWORD, t1.NOMBRE NOMBRE, t1.APELLIDO1 APELLIDO1, t1.APELLIDO2 APELLIDO2, t1.DNI DNI, t1.FECHA_NACIMIENTO FECHANACIMIENTO, t1.TELEFONO TELEFONO, t1.EMAIL EMAIL, t1.IDIOMA IDIOMA, t1.SEXO SEXO, t1.NOMBRE_IMAGEN NOMBRE_IMAGEN, t1.DIRECCION DIRECCION, t1.IMPORTE_MATRICULA IMPORTE_MATRICULA, t2.ID PaisID, t2.DS_O PaisDSO, t3.ID AutonomiaID, t3.DS_O AutonomiaDSO, t4.ID ProvinciaID, t4.DS_O ProvinciaDSO, t5.ID MunicipioID, t5.DS_O MunicipioDSO, t6.ID CalleID, t6.DS_O CalleDSO, t6.DS_E CalleDSE FROM ALUMNO t1, T17_PAIS t2, T17_AUTONOMIA t3, T17_PROVINCIA t4, T17_MUNICIPIO t5, T17_CALLE t6 WHERE t1.ID = ? AND t1.PAIS_ID=t2.ID(+) AND t1.AUTONOMIA_ID=t3.ID(+) AND t1.PROVINCIA_ID=t4.ID(+) AND t1.MUNICIPIO_ID=t5.ID(+) AND t1.CALLE_ID=t6.ID(+) ";
	 ...
	 */
	@Transactional(readOnly = true)
	public List<Alumno> findAllLike(Alumno alumno, Pagination pagination,
			Boolean startsWith) {
		List<Object> params = new ArrayList<Object>();
		...
		if (pagination != null) {
			if (pagination.getSort() != null) {
				query.append(" ORDER BY " + pagination.getSort() + " "
						+ pagination.getAscDsc());
			}
