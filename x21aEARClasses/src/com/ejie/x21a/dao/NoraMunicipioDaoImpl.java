...
public class NoraMunicipioDaoImpl implements NoraMunicipioDao {
	...
	public static final String[] ORDER_BY_WHITE_LIST = new String[] {"ID", "DSO", "PROVINCIAID", "COMARCAID"};
    ...
    */
    ...
    public List<NoraMunicipio> findAll(NoraMunicipio municipio, TableRequestDto tableRequestDto) {
		...
		StringBuilder query = new StringBuilder("SELECT  t1.ID ID,t1.DS_O DSO,t1.PROVINCIA_ID PROVINCIAID,t1.COMARCA_ID COMARCAID " 
			+ "FROM T17_MUNICIPIO t1 ");
		...
		if (tableRequestDto != null) {
			query = TableManager.getPaginationQuery(tableRequestDto, query, NoraMunicipioDaoImpl.ORDER_BY_WHITE_LIST);
		}
