...
public class JQGridUsuarioDaoImpl implements JQGridUsuarioDao {
	...
	public Usuario add(Usuario usuario) {
    	String query = "INSERT INTO USUARIO (ID, NOMBRE, APELLIDO1, APELLIDO2, EJIE, FECHA_ALTA, FECHA_BAJA, ROL) VALUES (?,?,?,?,?,?,?,?)";
    ...
    public Usuario update(Usuario usuario) {
		String query = "UPDATE USUARIO SET NOMBRE=?, APELLIDO1=?, APELLIDO2=?, EJIE=?, FECHA_ALTA=?, FECHA_BAJA=?, ROL=? WHERE ID=?";
