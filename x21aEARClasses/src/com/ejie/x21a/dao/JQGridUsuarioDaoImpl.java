...
@Repository
@Transactional
public class JQGridUsuarioDaoImpl implements JQGridUsuarioDao {
...
//		StringBuilder sbSQL = PaginationManagerJerarquia.getQueryChildren(pagination, mapaWhere, "ID", "ID_PADRE", from, from_alias, joins, businessFilters, businessParams);
	...
	private Map<String, ?> getWhereMap (Usuario usuario){
		...
		StringBuffer where = new StringBuffer(JQGridUsuarioDaoImpl.STRING_BUILDER_INIT);
	...
	private RowMapper<RssContent> rssMap = new RowMapper<RssContent>() {
		...
		public RssContent mapRow(ResultSet resultSet, int rowNum) throws SQLException {
			...
			titulo.append("  (").append(simpleDateFormat.format(resultSet.getTimestamp("FECHA_MODIF"))).append(") ");
			
			StringBuilder descripcion = new StringBuilder();
			descripcion.append("Nombre completo : ").append(resultSet.getString("APELLIDO1")).append(resultSet.getString("APELLIDO2")).append(", ").append(resultSet.getString("NOMBRE")).append("<br/>");
			descripcion.append("Rol : ").append(resultSet.getString("ROL")).append("<br/>");
			descripcion.append("Ejie : ").append(resultSet.getString("ROL")).append("<br/>");
			descripcion.append("Fecha alta : ").append(resultSet.getDate("FECHA_ALTA")).append("<br/>");
			descripcion.append("Fecha baja : ").append(resultSet.getDate("FECHA_BAJA")).append("<br/>");
		
			StringBuilder link = new StringBuilder();
			link.append(appConfiguration.get("rss.path")).append(resultSet.getString("ID"));
...
//		StringBuilder query = new StringBuilder("SELECT  t1.ID ID,t1.NOMBRE NOMBRE,t1.APELLIDO1 APELLIDO1,t1.APELLIDO2 APELLIDO2,t1.EJIE EJIE,t1.FECHA_ALTA FECHA_ALTA,t1.FECHA_BAJA FECHA_BAJA,t1.ROL ROL "); 
		StringBuilder query = new StringBuilder("SELECT  t1.ID ID,t1.NOMBRE NOMBRE,t1.APELLIDO1 APELLIDO1,t1.APELLIDO2 APELLIDO2,t1.EJIE EJIE,t1.FECHA_ALTA FECHA_ALTA,t1.FECHA_BAJA FECHA_BAJA,t1.ROL ROL,t1.FECHA_MODIF FECHA_MODIF ");
        query.append("FROM USUARIO t1 ");
...
//		where.append(mapaWhere.get("query"));
		query.append(where);
		query.append(" ORDER BY FECHA_ALTA DESC ");

//		List<?> params = (List<?>) mapaWhere.get("params");

		filteredQuery.append("SELECT * FROM (SELECT rownum rnum, a.*  FROM (" + query + ")a) where rnum > 0 and rnum < 30");
		
		return (List<RssContent>) this.jdbcTemplate.query(filteredQuery.toString(), this.rssMap);
