...
import com.ejie.x38.dto.PaginationManagerJerarquiaGrid;
...
public class UsuarioJerarquiaDaoImpl implements UsuarioJerarquiaDao {
	...
	public UsuarioJerarquia add(UsuarioJerarquia usuariojerarquia) {
		...
		this.jdbcTemplate.update(query, nextId, usuariojerarquia.getNombre(), usuariojerarquia.getApellido1(), usuariojerarquia.getApellido2(), usuariojerarquia.getEjie(), usuariojerarquia.getFechaAlta(), usuariojerarquia.getFechaBaja(), usuariojerarquia.getIdPadre(), usuariojerarquia.getGrupo());
		
		usuariojerarquia.setIdPadre(String.valueOf(nextId));
...
//	     }	
	 ...
	 *************/
	 ...
	 private RowMapper<JerarquiaDto<UsuarioJerarquia>> rwMapJerarquia = new RowMapper<JerarquiaDto<UsuarioJerarquia>>() {
			public JerarquiaDto<UsuarioJerarquia> mapRow(ResultSet resultSet, int rowNum) throws SQLException {
				...
				JerarquiaDto<UsuarioJerarquia> jerarquia = new JerarquiaDto<UsuarioJerarquia>();
	...
	public List<JerarquiaDto<UsuarioJerarquia>> findAllLikeJerarquia(UsuarioJerarquia usuarioJerarquia, Pagination pagination){
		...
		//JERARQUIA
		sbSQL = PaginationManagerJerarquiaGrid.getQuery(pagination, sbSQL, mapaWhere, "ID", "ID_PADRE", "NOMBRE", from, from_alias);
//		sbSQL = PaginationManagerJerarquiaGrid.getQuery(pagination, sbSQL, mapaWhere, "ID", "ID_PADRE", "NOMBRE", from, from_alias, joins, businessFilters, businessParams);
...
//		StringBuilder sbSQL = PaginationManagerJerarquia.getQueryCount(pagination, mapaWhere, "ID", "ID_PADRE", from, from_alias, joins, businessFilters, businessParams);
	...
	public TreeMap<String, TreeMap<String, String>> findAllLikeSelected (UsuarioJerarquia usuarioJerarquia, Pagination pagination){
		...
		//SELECTED
		sbSQL = PaginationManagerJerarquiaGrid.getQuerySelectedGrid(pagination, sbSQL, mapaWhere, usuarioJerarquia, "ID", "ID_PADRE", from, from_alias);
//		sbSQL = PaginationManagerJerarquiaGrid.getQuerySelectedGrid(pagination, sbSQL, mapaWhere, usuarioJerarquia, "ID", "ID_PADRE", from, from_alias, joins, businessFilters, businessParams, businessNames);
		
		List<?> params = (List<?>) mapaWhere.get("params");

		return this.jdbcTemplate.query(sbSQL.toString(), PaginationManagerJerarquiaGrid.selectedExtractorGrid, params.toArray());
	}
}