...
public class NoraCalleDaoImpl implements NoraCalleDao {
	...
	private RowMapper<NoraCalle> rwMap = new RowMapper<NoraCalle>() {
		public NoraCalle mapRow(ResultSet resultSet, int rowNum) throws SQLException {
           return new NoraCalle(
               resultSet.getLong("ID"), resultSet.getBigDecimal("CALLECOD"), resultSet.getString("DSO"), resultSet.getString("DSE"), resultSet.getString("PROVINCIAID"), resultSet.getString("MUNICIPIOID"), resultSet.getString("TIPOVIA"), resultSet.getString("TIPOVIAID"), resultSet.getString("ESTADO")
           ); } } ;
    ...
    */
    ...
    public List<NoraCalle> findAll(NoraCalle calle, Pagination pagination) {
		...
		StringBuffer query = new StringBuffer("SELECT  t1.ID ID,t1.CALLE_COD CALLECOD,t1.DS_O DSO,t1.DS_E DSE,t1.PROVINCIA_ID PROVINCIAID,t1.MUNICIPIO_ID MUNICIPIOID,t1.TIPO_VIA TIPOVIA,t1.TIPO_VIA_ID TIPOVIAID,t1.ESTADO ESTADO " 
			+ "FROM T17_CALLE t1 ");
