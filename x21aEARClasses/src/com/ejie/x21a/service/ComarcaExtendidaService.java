...
public interface ComarcaExtendidaService {
	 ...
	 * @param startsWith Boolean
	 */
	void removeMultiple(ComarcaExtendida filterComarca, TableRequestDto tableRequestDto, Boolean startsWith);
	...
	TableResourceResponseDto<ComarcaExtendida> filter(ComarcaExtendida comarca, TableRequestDto tableRequestDto, Boolean startsWith) ;
