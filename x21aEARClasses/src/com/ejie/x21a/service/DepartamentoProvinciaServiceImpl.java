...
public class DepartamentoProvinciaServiceImpl implements DepartamentoProvinciaService {
	...
	public List<DepartamentoProvincia> findAll(DepartamentoProvincia departamentoProvincia, TableRequestDto tableRequestDto) {
		return (List<DepartamentoProvincia>) this.departamentoProvinciaDao.findAll(departamentoProvincia, tableRequestDto);
	}
	...
	public List<DepartamentoProvincia> findAllLike(DepartamentoProvincia departamentoProvincia, TableRequestDto tableRequestDto, Boolean startsWith) {
		return (List<DepartamentoProvincia>) this.departamentoProvinciaDao.findAllLike(departamentoProvincia, tableRequestDto, startsWith);
	}
