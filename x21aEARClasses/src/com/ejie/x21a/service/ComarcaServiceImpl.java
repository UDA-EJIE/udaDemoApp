...
/**
 * ComarcaServiceImpl generated by UDA 1.0, 26-may-2011 13:45:00.
* @author UDA
*/
...
public  class ComarcaServiceImpl implements ComarcaService {
    ...
    * Final static logger.
    */
    private static final  Logger  logger = Logger.getLogger(ComarcaServiceImpl.class);
@Autowired
    ...
    */
    ...
    public void setComarcaDao(ComarcaDao comarcaDao) {
        logger.log(Level.INFO, "Setting Dependency "+comarcaDao);
