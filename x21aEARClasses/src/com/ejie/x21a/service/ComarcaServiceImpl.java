...
/**
 * ComarcaServiceImpl generated by UDA", 21-Nov-2024 13:03:25.
 * @author UDA
 */
...
public class ComarcaServiceImpl implements ComarcaService {
	...
	public TableResponseDto<Comarca> filter(Comarca filterComarca, TableRequestDto tableRequestDto, Boolean startsWith) {
		...
		TableResponseDto<Comarca> tableResponseDto = new TableResponseDto<Comarca>(tableRequestDto, recordNum, listaComarca);
	 ...
	 */	
    public List<TableRowDto<Comarca>> search(Comarca filterComarca, Comarca searchComarca, TableRequestDto tableRequestDto, Boolean startsWith) {
		return this.comarcaDao.search(filterComarca, searchComarca, tableRequestDto, startsWith);
	}
	 ...
	 * @return Object
	 */	
    public Object reorderSelection(Comarca filterComarca, TableRequestDto tableRequestDto, Boolean startsWith) {
		return this.comarcaDao.reorderSelection(filterComarca, tableRequestDto, startsWith);
	}
	 ...
	 */
	@Override
	public void generateReport(Comarca filterComarca, String[] columns, String[] columnsName, String fileName, String sheetTitle, ArrayList<?> reportsParams,
			TableRequestDto tableRequestDto, Locale locale, HttpServletRequest request, HttpServletResponse response) {
	 ...
	 * @param response     HttpServletResponse
	 */
	private void generateExcelReport(List<Comarca> filteredData, String[] columns,String[] columnsName, String fileName, String sheetTitle,
	 ...
	 * @param response     HttpServletResponse
	 */
	private void generatePDFReport(List<Comarca> filteredData, String[] columns, String[] columnsName, String fileName,
	 ...
	 * @param response     HttpServletResponse
	 */
	private void generateODSReport(List<Comarca> filteredData, String[] columns, String[] columnsName, String fileName, String sheetTitle,
			HttpServletResponse response) {
		try {
	 ...
	 * @param response     HttpServletResponse
	 */
	private void generateCSVReport(List<Comarca> filteredData, String[] columns, String[] columnsName, String fileName, String sheetTitle,
