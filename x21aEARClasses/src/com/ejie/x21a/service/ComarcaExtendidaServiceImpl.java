...
public class ComarcaExtendidaServiceImpl implements ComarcaExtendidaService {
	...
	@Override
	public TableResponseDto<ComarcaExtendida> filter(ComarcaExtendida filterComarca, TableRequestDto tableRequestDto, Boolean startsWith) {
		...
		TableResponseDto<ComarcaExtendida> comarcaDto = new TableResponseDto<ComarcaExtendida>(tableRequestDto, recordNum, listaComarcaExtendida);
