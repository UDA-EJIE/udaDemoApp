...
NOMBRE_FICHERO_LOGS=aa79bSubirDocumentoPid_${DATE}_${TIME}
...
echo " "
echo "---------------------------------------------------------------------------------------------------------" >> $FICHERO_LOGS
echo "Comienzo del proceso batch java AA79B (Subir documento al PID) ....." >> $FICHERO_LOGS
date >>  $FICHERO_LOGS
echo " " >> $FICHERO_LOGS
...
export DB_DRIVER
#Definimos el id del documento como parámetro
IDDOC=$1
