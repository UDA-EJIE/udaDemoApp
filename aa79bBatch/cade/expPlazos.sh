...
NOMBRE_FICHERO_LOGS=aa79bAvisoExpiracionPlazos_${DATE}_${TIME}
...
CLASE_JAVA=AvisoExpiracionPlazos
export CLASE_JAVA
...
echo " "
echo "---------------------------------------------------------------------------------------------------------" >> $FICHERO_LOGS
echo "Comienzo del proceso batch java AA79B (Aviso expiración de plazos) ....." >> $FICHERO_LOGS
date >>  $FICHERO_LOGS
echo " " >> $FICHERO_LOGS
