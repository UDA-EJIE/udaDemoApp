...
NOMBRE_FICHERO_LOGS=aa79bAnulacionExpedientes_${DATE}_${TIME}
...
CLASE_JAVA=AnulacionExpedientes
export CLASE_JAVA
...
echo " "
echo "---------------------------------------------------------------------------------------------------------" >> $FICHERO_LOGS
echo "Comienzo del proceso batch java AA79B (Anulación de expedientes) ....." >> $FICHERO_LOGS
date >>  $FICHERO_LOGS
echo " " >> $FICHERO_LOGS
