 ...
 *
 */
public class AccesoBDTransaccional{
     ...
     * @throws Exception e
     */
    public String fncConsultaEspecifica(String strPfSelect,Object[] arrPfCampos, BaseSqlTransaccional baseSql) throws Exception {

        Connection conexionBD = null;
        PreparedStatement preparedStatement = null;
        ResultSet rs = null;
        try {
            conexionBD = baseSql.getDbConnection();
    ...
    public <T>List<T> fncLanzaBusqueda(String strPfSelect,
            Object[] arrPfCampos, RowMapper<T> rowMapper, BaseSqlTransaccional baseSql) throws Exception {
     ...
     * @throws Exception e
     */
    public int fncLanzaMovimiento(String strPfSQL, Object[]  arrPfCampos, BaseSqlTransaccional baseSql)
            throws Exception {
     ...
     * @throws Exception e
     */
    public void fncLanzaMovimientosBatch(List<Statement> arrSQLs, BaseSqlTransaccional baseSql)
            throws Exception {
