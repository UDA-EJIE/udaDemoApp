...
public class IberdokFileServiceImpl implements IberdokFileService {
	...
	@Override
	public TableResponseDto<IberdokFile> filter(IberdokFile filterFile, TableRequestDto tableRequestDto, Boolean startsWith) {
		...
		TableResponseDto<IberdokFile> iberdokDto = new TableResponseDto<IberdokFile>(tableRequestDto, recordNum, listaIberdokFile);
