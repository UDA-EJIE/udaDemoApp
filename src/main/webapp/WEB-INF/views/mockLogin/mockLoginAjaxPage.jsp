...
<div id="mockPageContent" class="preview">
	...
	<div class="login-inner ui-widget">	
		<div class="login-up">
			...
			<img src="${staticsUrl}/css/images/login.png" alt='<spring:message code="app.title"/>'>
			<div class="separator"></div>
		</div>
...
<script src="${staticsUrl}/x21a/scripts/x21aPilotoPatrones/mockLoginAjaxPage.js" type="text/javascript"></script>