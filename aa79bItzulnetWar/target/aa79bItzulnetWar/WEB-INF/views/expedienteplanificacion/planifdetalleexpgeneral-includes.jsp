...
<script>
	var origen = '<%=Constants.PLANIFICACION%>';
	...
	var expedCerrado = <%=EstadoExpedienteEnum.CERRADO.getValue()%>;
	var expedEnCurso = <%=EstadoExpedienteEnum.EN_CURSO.getValue()%>;
...
<script src="${staticsUrl}/aa79b/scripts/aa79bItzulnet/planifdetalleexpgeneral.js" type="text/javascript"></script>
