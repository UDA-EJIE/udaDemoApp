...
<script>
	...
	var labelDocusRevisarTradExt='<spring:message code="label.documentosARevisar"/>';
...
<script src="${staticsUrl}/aa79b/scripts/aa79bItzulnet/tarearevisartraduccionext.js" type="text/javascript"></script>