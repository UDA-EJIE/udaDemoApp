...
<div class="container-fluid aa79b-fade in  aa79b-content" id="divEjecutarTareaCapa">
	<div id="tareaNoConformidadTrad_div">
		...
		<div id="pestanasModalNoConformidadTrad">
			<div id="tabsModalNoConformidadTrad" class="tabsEjecutarTarea"></div>
		</div>
	
		<input type="hidden" id="idiomaDest" name="idiomaDest" />
		<div id="pestDocsNoConformidadTrad">
			<div id="docsNoConformidadTrad_div">
				<div id="docsNoConformidadTrad_feedback"></div>						<!-- Feedback de la tabla -->
				<div id="docsNoConformidadTrad_toolbar"></div>							<!-- Botonera de la tabla -->
				<div id="contenFormularios" class="filterForm oculto">	
					<form id="docsNoConformidadTrad_filter_form" class="form-horizontal">						<!-- Formulario de filtrado -->
						<div id="docsNoConformidadTrad_filter_toolbar" class="formulario_legend"></div>	<!-- Barra de herramientas del formulario de filtrado -->
						<fieldset id="docsNoConformidadTrad_filter_fieldset" class="rup-table-filter-fieldset">
				...
				<div class="horizontal_scrollable_table">
					<!-- Tabla -->
					<table id="docsNoConformidadTrad"></table>
					<!-- Barra de paginación -->
					<div id="docsNoConformidadTrad_pager"></div>
				</div>
