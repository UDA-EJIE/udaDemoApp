...
<div class="container-fluid aa79b-fade in  aa79b-content" id="divEjecutarTareaCapa">
	<div id="tareaRevisarTradExt_div">
		...
		<div id="datosProveedor">
					...
					<div class="p-2">
						<div class="row">
							<div class="form-group col-lg-3">
								<label class="control-label" for="retraso_tradExt"><spring:message code="label.retraso"/>:</label>
								<label class="control-label" id="retraso_tradExt"></label>
								<input type="hidden" id="retrasoVal_tradExt" >
							</div>
						</div>
					</div>
				</fieldset>
			...
			<div class="row margen1TB">
				<div class="form-group col-lg-3">
					<label class="control-label" for="porPenalizacionSwitch_tradExt"><spring:message code="label.penalizacionPorRetraso"/>:</label>
					<input type="checkbox" id="porPenalizacionSwitch_tradExt" value="S" data-switch-pestana="true">
				</div>
				<div class="form-group col-lg-4">
					<label class="control-label" for="porcentajePenalizacion_tradExt"><spring:message code="label.porcentajePenalizacion"/>:</label>
					<input type="text" style="width:100px" class="form-control numeric" id="porcentajePenalizacion_tradExt" name="porPenal"  disabled maxlength="3" />
				</div>
			</div>
			
			<div class="row margen1TB">
				<div class="form-group col-lg-3">
					<label for="calidad_combo_tradExt" class="control-label"><spring:message code="label.calidadTrabajoRealizado" /></label>
					<select class="form-control" id="calidad_combo_tradExt" ></select>
				</div>
			</div>
		</div>
		<div id="pestanasModalRevTradExt">
			<div id="tabsModalRevTradExt" class="tabsEjecutarTarea"></div>
		</div>
	
		<input type="hidden" id="idiomaDest" name="idiomaDest" />
		<div id="pestDocsRevisarTradExt">
			<div id="docsRevisarTradExt_div">
				<div id="docsRevisarTradExt_feedback"></div>						<!-- Feedback de la tabla -->
				<div id="docsRevisarTradExt_toolbar"></div>							<!-- Botonera de la tabla -->
				<div id="contenFormularios" class="filterForm oculto">	
					<form id="docsRevisarTradExt_filter_form" class="form-horizontal">						<!-- Formulario de filtrado -->
						<div id="docsRevisarTradExt_filter_toolbar" class="formulario_legend"></div>	<!-- Barra de herramientas del formulario de filtrado -->
						<fieldset id="docsRevisarTradExt_filter_fieldset" class="rup-table-filter-fieldset">
				...
				<div class="horizontal_scrollable_table">
					<!-- Tabla -->
					<table id="docsRevisarTradExt"></table>
					<!-- Barra de paginación -->
					<div id="docsRevisarTradExt_pager"></div>
				</div>
	...
	<form id="ejecutarTareaDialog_form">
		...
		<input type="hidden" name="datosPagoProveedores.indPenalizacion" id="indPenalizacion_form_tradExt" >
		<input type="hidden" name="datosPagoProveedores.porPenalizacion" id="porPenalizacion_form_tradExt" >
		<input type="hidden" name="datosPagoProveedores.nivelCalidad" id="nivelCalidad_form_tradExt" >
		<input type="hidden" name="indFacturable" id="indFacturable_form_tradExt" >
	</form>
</div>
