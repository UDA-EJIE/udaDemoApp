...
public class Aa79bSolicitudTramitagune implements Serializable {

	private static final long serialVersionUID = 1L;

	private String codigoAplicacion;
	private String referenciaExpediente;
	private AA79bDatosSolicitanteTramitagune datosSolicitante;
	private AA79bDatosFacturacionTramitagune datosFacturacion;
	...
	public AA79bDatosSolicitanteTramitagune getDatosSolicitante() {
		return this.datosSolicitante;
	}
	public void setDatosSolicitante(AA79bDatosSolicitanteTramitagune datosSolicitante) {
		this.datosSolicitante = datosSolicitante;
	}
	public AA79bDatosFacturacionTramitagune getDatosFacturacion() {
		return this.datosFacturacion;
	}
	public void setDatosFacturacion(AA79bDatosFacturacionTramitagune datosFacturacion) {
