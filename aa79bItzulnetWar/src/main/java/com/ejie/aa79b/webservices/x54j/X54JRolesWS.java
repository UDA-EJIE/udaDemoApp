...
/**
 * <p>Java class for X54JRolesWS complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="X54JRolesWS">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="permisos" type="{java:x54j.x54jbeans}ArrayOfX54JPermisosWS"/>
...
@XmlType(name = "X54JRolesWS", propOrder = {
    "permisos",
    "codigo",
    "desCas",
    "desEus"
})
public class X54JRolesWS {

    @XmlElement(required = true, nillable = true)
    protected ArrayOfX54JPermisosWS permisos;
    @XmlElement(required = true, nillable = true)
     ...
     * @return
     *     possible object is
     *     {@link ArrayOfX54JPermisosWS }
     *     
     */
    public ArrayOfX54JPermisosWS getPermisos() {
        return permisos;
    }
     ...
     *     
     */
    public void setPermisos(ArrayOfX54JPermisosWS value) {
        this.permisos = value;
    }
