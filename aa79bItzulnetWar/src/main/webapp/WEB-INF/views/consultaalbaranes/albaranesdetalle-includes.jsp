...
<script type="text/javascript">
	...
	var txtFacturable = '<spring:message code="label.facturableTitle"/>';
	var txtIndAlbaran = '<spring:message code="label.indalbaran"/>';
...
<script src="${staticsUrl}/aa79b/scripts/aa79bItzulnet/consultaalbaranesdetalle.js" type="text/javascript"></script>
