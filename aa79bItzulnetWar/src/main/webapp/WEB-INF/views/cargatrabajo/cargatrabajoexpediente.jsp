...
<div class="container-fluid aa79b-fade in"
	...
	<div class="form-group col-xs-6 col-lg-2 col-xl-2">
		<label for="indDesglose" class="control-label"><spring:message code="label.desgloseTareas" /></label>
		<div>
			<input type="checkbox" name="indDesglose" class="form-control"
				id="indFacturable_exp" value="S" data-switch-pestana="true" />
		</div>
	</div>
	<div class="col-xl-12  col-xs-12  col-sm-12">
		<div id="ganttExpediente" class="gantt"></div>
	</div>
	<div class="row">
		<div class="form-group col-lg-12">
			<div class="col-xs-12">
				<div id="tipoTareaTal" class="control-label col-xs-1 no-padding-left ganttExpediente ganttIndex"></div>
				<label for="tipoTarea_detail_table"
					class="control-label col-xs-3 no-padding-left"><spring:message
					code="label.duracionExp" /></label> 
			</div>
		</div>
	</div>		
	<div class="row">
