...
<div id="divExpedienteInterpretacion">
	<fieldset id="datos_expediente_interpretacion_filter_fieldset">
		...
		<input type="hidden" name="expedienteInterpretacion.indObservaciones" id="indObservacionesInterpretacion">
		...
		<div class="row oculto" id="notaTareasEjecutadasInter" style="padding:1rem">
		...
		<div class="row">
			...
			<div class="form-group col-lg-2" id="enlaceBuscarDireccionNora" style="display:none;">
		...
		<div id="divSeccionObservacionesI" class="row"> 
			<div class="col-lg-4">
				<label class="control-label" for="observacionesExpInter"><spring:message code="label.observacionesSolicitud"/>:
					<div id="observaciones_mostrarLink_divI" class="inline">
						(<a id="observaciones_mostrarLinkI" href="#" class="control-label"><spring:message code="label.mostrar" /></a>)
					</div>
				</label>
			</div>
		</div>
		<div id="divDetalleObservacionesI">
			<div class="row">
				<div class="form-group col-lg-12">
	<%-- 				<label class="control-label" for="observacionesExpInter"><spring:message code="label.observaciones"/>:</label> --%>
					<textarea name="expedienteInterpretacion.observaciones.observaciones" class="form-control resizable-textarea" id="observacionesInterpretacion" rows="3" cols="9" maxlength="4000" readonly="readonly" disabled="disabled"></textarea>
				</div>
			</div>
		</div>
	</fieldset>
