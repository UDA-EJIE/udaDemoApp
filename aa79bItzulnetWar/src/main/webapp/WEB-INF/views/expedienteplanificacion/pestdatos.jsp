...
<div class="container-fluid aa79b-fade in" id="divPestDatos">
				...
				<fieldset id="busquedaDatos_filter_fieldset">	
					<div class="row">
						<div class="form-group col-xs-4">
							<label for="filtro_combo" class="control-label col-xs-12 no-padding" data-i19n="label.planif.filtro"><spring:message code="label.planif.filtro" />(*):</label>
							<select  name="filtroDatos" class="form-control" id="filtro_combo" ></select>
						</div>
					</div>
					<div class="row">
						<div class="col-xs-3">
							<label for="grupoTrabajo_combo" class="control-label col-xs-12"><spring:message code="label.grupoTrabajo" /></label>
							<select  name="idsGrupoTrabajo" class="form-control" id="grupoTrabajo_combo" ></select>
						</div>
						<div class="col-xs-4">
							<label for="asignador_combo" class="control-label col-xs-12 no-padding"><spring:message code="label.asignador"/>:</label>
							<select  name="tecnico.dni" class="form-control" id="asignador_combo" ></select>
						</div>
					</div>
					<div id="busquedaDatos_filter_buttonSet" class="pull-right" style="margin:0 1rem 1rem 0">
						<button id="busquedaDatos_Boton_filtro" type="button" class="ui-button ui-widget ui-state-default ui-corner-all">
