...
<div class="container-fluid aa79b-fade in aa79b-content" id="divEjecutarTareaCapa">
	<div id="tareaCorredaccion_div">
		...
		<div id="pestanasModalCorredaccion">
			<div id="tabsModalCorredaccion" class="tabsEjecutarTarea"></div>
		</div>
		...
		<div id="pestDocsTraducir">
			<div id="docsTraducir_div">
				...
				<div class="leyendaDocs">
					<p><span class="ico-ficha-encriptado"><i class="fa fa-eye" aria-hidden="true"></i></span> <spring:message code="label.visibleCliente"/></p>
					...
					<p><span class="ico-ficha-encriptado"><i class="fa fa-file-text" aria-hidden="true"></i></span> <spring:message code="label.documento.docTrabajo"/></p>
				</div>
			</div>
			<form id="datosExpedienteTradRev_form" style="margin-top:1rem">		
				<div class="row">
					<div class="form-group col-md-12 col-lg-6 grupoFechaHora">
		                ...
		                <button id="actualizarFhIZO" type="button" style="margin:0 1rem"><spring:message code="accion.actualizar"/></button>
		            </div>
			...
			<fieldset id="subidaFicheroPidFinal_fieldset" >			
				...
				<form id="subidaFicheroPidFinal_form" enctype="multipart/form-data" method="POST" class="form-horizontal">
					<div class="form-group row">
						...
						<input type="hidden" id="reqEncriptadoTarea" name="reqEncriptado" />
