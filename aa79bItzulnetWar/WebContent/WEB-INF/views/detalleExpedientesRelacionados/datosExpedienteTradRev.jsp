	...
	<fieldset id="datos_expediente_trad_rev_filter_fieldset">
		...
		<div class="row">
			...
			<div class="form-group col-lg-2">
				...
				<input type="checkbox" name="expedienteTradRev.indCorredaccion" id="indCorredaccion" value="S" data-switch-pestana="true" >
			</div>
		</div>
		...
		<div class="row">
			...
			<div id="capaBoe" class="oculto">
				<div class="form-group col-lg-2">
					<label class="control-label col-xs-12 no-padding-left" for="indPublicadoBoe"><spring:message code="label.boe"/>:</label>
					<input type="checkbox" name="expedienteTradRev.indPublicadoBoe" id="indPublicadoBoe" value="S" data-switch-pestana="true">
				</div>
				<div class="form-group col-lg-5" id="capaUrlBOE">
					<label class="control-label" for="urlBoe"><spring:message code="label.urlBoe"/>:</label>
					<input type="text" name="expedienteTradRev.urlBoe" class="form-control" id="urlBoe" maxlength="250" >
				</div>
			</div>
		</div>
	</fieldset>
