			...
			<div id="datosgeneralesexpedienteform_div">
				<div id="datosgeneralesexpediente_filter_div">
					<form id="datosgeneralesexpedienteform">
						...
						<%@include file="/WEB-INF/views/datosgeneralesexpediente/datosExpedientesRelacionados.jsp"%>
						<%@include file="/WEB-INF/views/datosgeneralesexpediente/datosSolicitante.jsp"%>
						<%@include file="/WEB-INF/views/datosgeneralesexpediente/datosExpediente.jsp"%>
						<%@include file="/WEB-INF/views/datosgeneralesexpediente/datosExpedienteInterpretacion.jsp"%>
						<%@include file="/WEB-INF/views/datosgeneralesexpediente/datosExpedienteTradRev.jsp"%>
						<%@include file="/WEB-INF/views/datosgeneralesexpediente/documentos.jsp"%>
						<%@include file="/WEB-INF/views/datosgeneralesexpediente/datosTecnico.jsp"%>
