...
<script src="${staticsUrl}/aa79b/scripts/aa79bItzulnet/consultarevisiondatosfacturacion.js" type="text/javascript"></script>
...
var expedientesSeleccionados = new Array();
	...
	var busqGen = {
			...
			'estadoPresupuesto' : {
				'pendiente' : '<%=EstadoRequerimientoEnum.PENDIENTE.getValue()%>',
				'aceptado' : '<%=EstadoRequerimientoEnum.ACEPTADA.getValue()%>',
