...
<script>
	...
	var labelDocRevisado='<spring:message code="tabla.subsanarDocumentoTraducido"/>';
...
<script src="${staticsUrl}/aa79b/scripts/aa79bItzulnet/tareanoconformidadtraductor.js" type="text/javascript"></script>