		...
		<form id="ejecutarTareaDialog_form">
			...
			<div class="row">
				<div class="form-group col-md-5 col-xl-5 ">
					<label for="tarea_realizada_filter" class="col-xs-12  noNegrita" data-i18n="label.enVigor"><spring:message code="label.seAceptaConformidad" /></label>
					<div class="col-xs-12">
						<input type="checkbox" name="indNoConformidad" class="form-control" id="tarea_realizada_filter" value="S" data-switch-pestana="true" />
					</div>
				</div>
			</div>
			<div class="row">
