...
<div class="container">
	<div class="row cabecera" id="subcabecera">
		...
		<div id="divContacto" class="col-md-6 cabecera-second pull-right">
		...
		<div id="divTradRev" class="col-md-3 cabecera-second pull-right">
			<div class="row cabecera-data ">
						
				<div id="divFechaFinalIzo">				
					<p class="cabecera-numero">
					<span class="cabecera_numExpediente"><spring:message code="label.fechaFinalIzo"/>: </span>
					<span id="cabecera_fechaFinalIzo"></span>
					</p>
				</div>
				
				<p class="cabecera-numero">
				<span class="cabecera_numExpediente"><spring:message code="label.idiomaDestino"/>: </span>
				<span id="cabecera_idiomaDestino"></span>
				</p>
