...
<!-- Formulario de detalle de la T53 -->
	<div id="datosExpedienteTradRev_div">
			...
			<form id="datosExpedienteTradRev_form">					<!-- Formulario -->
				<div id ="datosExpedienteTradRev_feedback"></div>		<!-- Feedback del formulario de detalle -->			
					...
					<div class="row">	
						...
						<div class="form-group col-xs-6 col-lg-3">
							<label for="indUrgente" class="control-label col-xs-12 no-padding"><spring:message code="label.urgente"/> (*):</label>
					...
					<div class="row">	
						<div class="form-group col-xs-6 col-lg-3" style="clear: left;">
							<label for="numTotalPalIzo" class="control-label col-xs-12 no-padding"><spring:message code="label.documento.numTotalPalIzo"/> (*):</label>						
						...
						<div id="capaFechaFinalProp" class="form-group col-lg-4 col-xl-4">
		...
		<div class="rup-table-buttonpane ui-widget-content ui-helper-clearfix">
			<div class="ui-dialog-buttonset">
				...
				<button id="finalizarAltaOficioTradRev" type="button" class="ui-button ui-widget ui-state-default ui-corner-all">
					<spring:message code="label.finalizarAltaOficio" />
				</button>
				<!-- Enlace cancelar -->
	...
	<div id="capaFinalizarExpOficioInterpretacion" class="rup-table-buttonpane ui-widget-content ui-helper-clearfix oculto">
		<div class="ui-dialog-buttonset">			
			<button id="finalizarAltaOficioInterpret" type="button" class="ui-button ui-widget ui-state-default ui-corner-all">
				<spring:message code="label.finalizarAltaOficio" />
			</button>			
		</div>
	</div>
					...
					<div class="row documento-all" id="filaDoc${documento.idDoc}">
			            ...
			            <div class="col-md-1 documento-second">
			              <div style="border-left: 1px solid #d9dce0;">
			              	<a class="eliminarDocumento"  href="#" data-id="${documento.idDoc}">
				                <span class="ico-ficha-right">
